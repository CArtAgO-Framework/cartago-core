...
public class ArtifactId implements java.io.Serializable {
	...
	public ArtifactId(String name, String artifactType, WorkspaceId wspId, AgentId creatorId){
		this.name = name;
		// this.id = id;
	 ...
	 */
	public String getId(){
		return name+"@"+workspaceId.getName();
	}
	...
	public boolean equals(Object aid){
		if (aid!=null && (aid instanceof ArtifactId)) {
			...
			return this.getId().equals(wId.getId());
			/*
			return (wId.getId()==id  
	...
	/**
	 * 
	 * Get the identifier of the agent who created this artifact.
	 * 
	 * @return
	 */
