...
public class CartagoContext {
	...
	private cartago.utils.agent.ObsPropMap obsPropMap;
	...
	public CartagoContext(AgentCredential cred){
		...
		obsPropMap = new cartago.utils.agent.ObsPropMap();
		credential = cred;
		agentRole = "";
		try {
			session = (AgentSession) CartagoEnvironmentStandalone.getInstance().startSession(credential, agentCallback);
	 ...
	 * @return
	 */
	public cartago.utils.agent.ArtifactObsProperty getObsProperty(String name){
