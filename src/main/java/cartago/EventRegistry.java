...
public class EventRegistry {
	...
	public JoinWSPRequestSucceededEvent makeJoinWSPRequestSucceededEvent(long actionId, ArtifactId aid, Op op, WorkspaceId wspId, String sid) {
		long id = nextTimestamp.incrementAndGet();
		JoinWSPRequestSucceededEvent ev = new JoinWSPRequestSucceededEvent(id, actionId, op, aid, wspId, sid);
		return ev;
	}
